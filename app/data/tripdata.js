export const rooms = [
  {
    ...
    city: "Ilha jeju",
    check_in_date: "05/05/2023",
    check_out_date: "05/05/2023",
    reservation: "HME8325",
    max_capacity: 2,
    bedrooms: 1,
    beds: 1,
  ...
  {
    id: 2,
    title: "Jeju Sensibility Acomodação Mini Mary [Quarto Mini Mary:]",
    property_type: "casa inteira",
    city: "Ilha jeju",
  ...
  {
    id: 3,
    title: "[High Residence] Estúdio recém-construído perto do aeroporto no centro de Shinjeju (Padrão)",
    property_type: "casa inteira",
    city: "Seul",
  ...
  {
    id: 4,
    title: "Uma casa no meio de um campo de tangerineiras, Tangerine Hanga nº 202",
    property_type: "casa inteira",
    city: "Seul",
  ...
  {
    id: 5,
    title: "Casa da Ju(2) a 9 km do aeroporto/ Hospedagem emocionante no 2º andar em frente à praia na cidade de Jeju",
    property_type: "casa inteira",
    city: "busan",
