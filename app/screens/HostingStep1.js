  ...
  return (
    <Container>
      <Main>
        <Top>
          <Header>
            <Typography.H color={colors.blueprimary}>Registre sua acomodação</Typography.H>
            <View style={{ marginTop: 14, marginBottom: 20 }}>
              <Typography.P colors={colors.gray}>
              Desde montar uma casa até pintar uma parede
              </Typography.P>
            </View>
            <BtnContainer>
              <Button.BtnContain
          ...
          <Card elevation={5}>
            ...
            <TextContainer>
              <View style={{ marginBottom: 8 }}>
                <Typography.H3>Ouça algum Autonômo</Typography.H3>
              </View>

              <Typography.P colors={colors.gray}>
              Marcia é uma autônoma de Medianera que quer dividir sua experiência com outras pessoas.
              </Typography.P>
            </TextContainer>
          </Card>
        </HostStory>
