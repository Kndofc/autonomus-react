  ...
  return (
    <Container>
      <Main>
        <SearchStart>
          <SearchTap
            placeholder="Localização, ponto de referência ou endereço"
            icon="search"
            size={20}
        ...
        <HLine />
        <HeroText>
          <Typography.H color={colors.blueprimary}>
          Explore serviços perto de você com o Autonomus
          </Typography.H>
        </HeroText>
        <FlatList
          data={homedata}
      ...
      <Footer>
        <HeroText>
          <Typography.H4 color={colors.gray}>Verifique as informações mais recentes</Typography.H4>
        </HeroText>
