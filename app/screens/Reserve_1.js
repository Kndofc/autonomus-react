...
const Reserve_1 = (props) => {
  ...
  return (
    <Container>
      <Detail>
        <MainWrapper>
          ...
          <Flex>
            ...
            <View>
              <Typogrpahy.Cap color={colors.gray}>Confira</Typogrpahy.Cap>
              <Typogrpahy.Sub1>{props.state.endDay}</Typogrpahy.Sub1>
            </View>
            <View>
              <Typogrpahy.Cap color={colors.gray}>convidado</Typogrpahy.Cap>
              <Typogrpahy.Sub1>{total()}명</Typogrpahy.Sub1>
            </View>
          </Flex>
          <HLine />
          <Flex>
            <Typogrpahy.Sub1>É uma viagem de negócios?</Typogrpahy.Sub1>
            <Switch
              trackColor={{ false: colors.faintgray, true: colors.blueprimary }}
          ...
          <View>
            ...
            <Flex>
              <Typogrpahy.Sub1>taxa de limpeza</Typogrpahy.Sub1>
              <Typogrpahy.Sub1>${calcCleaning()}</Typogrpahy.Sub1>
            </Flex>
            <Flex>
              <Typogrpahy.Sub1>taxa de serviço</Typogrpahy.Sub1>
              <Typogrpahy.Sub1>${calcFee()}</Typogrpahy.Sub1>
            </Flex>
            <HLine />
            <Flex>
              <Typogrpahy.Sub1>Soma</Typogrpahy.Sub1>
      ...
      <Reserve>
        <Button.BtnContain label="Fazer uma reserva" color={colors.blueprimary} />
        {/* enviar ação */}
      </Reserve>
    </Container>
  );
