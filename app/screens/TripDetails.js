  ...
  return (
    <Container>
      ...
      <Main>
        ...
        <Checkin>
          <View>
            <Typography.Cap color={colors.gray}>Data inicio do serviço</Typography.Cap>
            <Typography.Sub1>{trip.check_in_date}</Typography.Sub1>
          </View>
          <View>
            <Typography.Cap color={colors.gray}>Data final do serviço</Typography.Cap>
        ...
        <Host>
          <List.UserList
            ...
            subtitle="Membro desde: dezembro de 2018"
        ...
        <Rules>
          <View>
            ...
            <Typography.P>-Pode Fumar</Typography.P>
            <Typography.P>-Não pode animal</Typography.P>
