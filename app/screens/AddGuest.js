  ...
  return (
    <Container>
      <MainWrapper>
        <Flex>
          <View>
            <Typography.H3>adulto</Typography.H3>
            <Typography.P color={colors.gray}>13+</Typography.P>
          </View>
        ...
        <Flex>
          <View>
            <Typography.H3>crianças</Typography.H3>
            <Typography.P color={colors.gray}>2-12</Typography.P>
          </View>
        ...
        <Flex>
          <View>
            <Typography.H3>criança</Typography.H3>
            <Typography.P color={colors.gray}>2 anos</Typography.P>
          </View>
